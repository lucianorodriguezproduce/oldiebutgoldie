    ...
    if (!article) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-6">
                <h1 className="text-4xl font-display font-bold text-white">{TEXTS.comunidad.articleNotFound}</h1>
                <Link to="/editorial">
                    <button className="text-primary uppercase font-black tracking-widest hover:underline">{TEXTS.comunidad.backToEditorial}</button>
                </Link>
            </div>
        );
    }
    ...
    return (
        <ReactLenis root>
            ...
            <header className="space-y-8 md:space-y-12 mb-12 md:mb-16">
                ...
                <div className="flex flex-wrap items-center gap-8 md:gap-12 py-8 border-y border-white/5">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1">{TEXTS.comunidad.readingTime}</p>
                    ...
                    <button className="ml-auto flex items-center gap-3 text-gray-500 hover:text-white transition-colors">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">{TEXTS.comunidad.share}</span>
                    </button>
                </div>
            </header>
            ...
            <footer className="text-center space-y-8 pb-24 md:pb-32">
                <h3 className="text-2xl md:text-3xl font-display font-bold text-white uppercase tracking-widest">{TEXTS.comunidad.endOfDispatch}</h3>
                <p className="text-gray-500 font-medium">{TEXTS.comunidad.stayTuned}</p>
                <Link to="/editorial">
                    <button className="mt-8 bg-white text-black px-10 py-4 rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-primary transition-all">
                        {TEXTS.comunidad.exploreOtherArticles}
                    </button>
                </Link>
            </footer>
        </motion.div>
