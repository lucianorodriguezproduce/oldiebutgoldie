            ...
            return (
                <div className="mt-8 space-y-6">
                    <div className="p-8 bg-emerald-500/5 border border-emerald-500/20 rounded-[2.5rem] flex flex-col items-center gap-4 text-center">
                        ...
                        <TradeChat tradeId={id!} currentUser={user} trade={order} otherParticipantName={isOwner ? `@${order.highest_bidder_name || order.buyer_name || 'Comprador'}` : `@${order.user_name || 'Vendedor'}`} />
                    </div>
                </div>
            );
        }
