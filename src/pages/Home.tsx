            ...
            <section>
                <div className="flex items-center justify-between mb-10">
                    <div>
                        <h2 className="text-3xl md:text-4xl font-display font-bold text-white tracking-tightest">
                            {query ? `Resultados para "${query}"` : genre ? `Lanzamientos de ${genre}` : "Nuevos Lanzamientos"}
                        </h2>
                ...
                {!isLoading && (!results || results.length === 0) && (
                    ...
                    >
                        ...
                        <button onClick={() => { setQuery(""); setGenre(null); }} className="mt-4 text-primary font-bold hover:underline underline-offset-8 transition-all">Reiniciar parámetros de búsqueda</button>
                    </motion.div>
                )}
            </section>
                    ...
                    {[
                        {
                            ...
                            title: "Más allá del Sintetizador",
                            subtitle: "Una entrevista exclusiva con los pioneros del French Touch",
                            image: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?q=80&w=1000&auto=format&fit=crop",
                        },
                        {
                            category: "Arquitectura",
                            title: "La Arquitectura del Sonido",
                            subtitle: "Dentro del estudio de un maestro minimalista",
                        ...
                        },
                        {
                            ...
                            subtitle: "Por qué los medios físicos importan más que nunca",
