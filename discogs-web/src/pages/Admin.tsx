...
export default function Admin() {
    ...
    return (
        <div className="space-y-10 p-6">
            <header>
                <h1 className="text-5xl font-display font-black text-white tracking-tightest">System Pilot <span className="text-primary">Dashboard</span></h1>
                <p className="text-gray-500 mt-2 font-medium">Deterministic lead generation and global traffic telemetry.</p>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <CardContent className="p-8 space-y-6">
                        {stats?.topCities.map(([city, count]: any) => (
                            <div key={city} className="flex items-center justify-between group">
                                ...
                                <span className="text-gray-600 font-black">{count} Hits</span>
                            </div>
                        ))}
                    </CardContent>
                </Card>
                ...
                <Card className="bg-primary/5 border border-primary/20 backdrop-blur-3xl rounded-[2.5rem] p-10 flex flex-col justify-center items-center text-center">
                    ...
                    <h2 className="text-3xl font-black text-white mb-4">Harvester Active</h2>
                    <p className="text-gray-400 max-w-sm">
                        The Argentina Harvester tool is currently scanning Discogs for new collectors. New leads will appear in your database automatically.
                    </p>
